...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $hrm = new class { use \App\Traits\PxTraits\Policies\Items\HrmUserPolicyTrait, \App\Traits\PxTraits\Policies\Items\ApiPolicyTrait, \App\Traits\PxTraits\Policies\Items\DataLibraryPolicyTrait; };
        foreach (array_merge($hrm->hrmUserPolicies()['policies'], $hrm->apiPolicies()['policies'], $hrm->dataLibraryPolicies()['policies']) as $policy) {
