...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $hrm = new class { use \App\Traits\PxTraits\Policies\Items\HrmUserPolicyTrait, \App\Traits\PxTraits\Policies\Items\ApiPolicyTrait, \App\Traits\PxTraits\Policies\Items\DataLibraryPolicyTrait, \App\Traits\PxTraits\Policies\Items\CategoryPolicyTrait, \App\Traits\PxTraits\Policies\Items\AccountPolicyTrait, \App\Traits\PxTraits\Policies\Items\HrStaffPolicyTrait; };
        foreach (array_merge($hrm->hrmUserPolicies()['policies'], $hrm->apiPolicies()['policies'], $hrm->dataLibraryPolicies()['policies'], $hrm->categoryPolicies()['policies'], $hrm->accountPolicies()['policies'], $hrm->hrStaffPolicies()['policies']) as $policy) {
