...
namespace App\Http\Controllers\Api\V1\Admin\Hrm\User\Crud\Modify\DoctorOpdSlot\Crud;
...
#[\Dedoc\Scramble\Attributes\Group('Human Resource / Doctor OPD Slot')]
class AdminUserOpdSlotCrudController  extends Controller {
    ...
    #[\Dedoc\Scramble\Attributes\QueryParameter('admin_user_id', type: 'int', required: true, description: 'The doctor (admin_user) this OPD slot list belongs to')]
    ...
    #[\Dedoc\Scramble\Attributes\Endpoint(title: 'Read admin user opd slot data')]
    #[\Dedoc\Scramble\Attributes\QueryParameter('admin_user_id', type: 'int', required: true, description: 'The doctor (admin_user) this OPD slot list belongs to')]
    #[\Dedoc\Scramble\Attributes\Response(200, description: 'JSON response. For legacy mutations also check success and errors.', type: 'array{success: bool, data?: mixed, errors?: array<string, array<string>>, noUpdate?: bool, title?: string, message?: string}')]
    #[\Dedoc\Scramble\Attributes\Response(401, description: 'Missing, invalid or expired token; or incorrect login credentials', type: 'array{success: bool, message: string}')]
    #[\Dedoc\Scramble\Attributes\Response(403, description: 'Disabled account, incomplete setup or missing permission', type: 'array{success: bool, message: string, code?: string, ability?: string}')]
    ...
    #[\Dedoc\Scramble\Attributes\BodyParameter('admin_user_id', type: 'int', required: true, description: 'The doctor (admin_user) this OPD slot list belongs to')]
    ...
    #[\Dedoc\Scramble\Attributes\BodyParameter('admin_user_id', type: 'int', required: true, description: 'The doctor (admin_user) this OPD slot belongs to')]
    #[\Dedoc\Scramble\Attributes\BodyParameter('year', type: 'string', required: true, description: 'Max 253 characters')]
    #[\Dedoc\Scramble\Attributes\BodyParameter('month', type: 'string', required: true, description: 'Max 253 characters')]
    #[\Dedoc\Scramble\Attributes\BodyParameter('day', type: 'string', required: true, description: 'Max 253 characters')]
    #[\Dedoc\Scramble\Attributes\BodyParameter('slot', type: 'string', required: true, description: 'Max 253 characters')]
    #[\Dedoc\Scramble\Attributes\Response(200, description: 'JSON response. For legacy mutations also check success and errors.', type: 'array{success: bool, data?: mixed, errors?: array<string, array<string>>, noUpdate?: bool, title?: string, message?: string}')]
    #[\Dedoc\Scramble\Attributes\Response(401, description: 'Missing, invalid or expired token; or incorrect login credentials', type: 'array{success: bool, message: string}')]
    #[\Dedoc\Scramble\Attributes\Response(403, description: 'Disabled account, incomplete setup or missing permission', type: 'array{success: bool, message: string, code?: string, ability?: string}')]
    ...
    #[\Dedoc\Scramble\Attributes\BodyParameter('year', type: 'string', required: false, description: 'Max 253 characters')]
    #[\Dedoc\Scramble\Attributes\BodyParameter('month', type: 'string', required: false, description: 'Max 253 characters')]
    #[\Dedoc\Scramble\Attributes\BodyParameter('day', type: 'string', required: false, description: 'Max 253 characters')]
    #[\Dedoc\Scramble\Attributes\BodyParameter('slot', type: 'string', required: false, description: 'Max 253 characters')]
    #[\Dedoc\Scramble\Attributes\Response(200, description: 'JSON response. For legacy mutations also check success and errors.', type: 'array{success: bool, data?: mixed, errors?: array<string, array<string>>, noUpdate?: bool, title?: string, message?: string}')]
    #[\Dedoc\Scramble\Attributes\Response(401, description: 'Missing, invalid or expired token; or incorrect login credentials', type: 'array{success: bool, message: string}')]
    #[\Dedoc\Scramble\Attributes\Response(403, description: 'Disabled account, incomplete setup or missing permission', type: 'array{success: bool, message: string, code?: string, ability?: string}')]
