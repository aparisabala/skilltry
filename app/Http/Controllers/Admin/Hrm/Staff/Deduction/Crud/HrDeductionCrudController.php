...
namespace App\Http\Controllers\Admin\Hrm\Staff\Deduction\Crud;
...
class HrDeductionCrudController  extends Controller {
    ...
    public function index(Request $request) : View | RedirectResponse
    {
        ...
        return view('admin.pages.hrm.staff.deduction.crud.index',compact('data'));
    }

    /**
     * List items for yajra datatable for deduction crud
     *
     * @param Request $request
     * @return JsonResponse
     */
    ...
    /**
     * Store procedure for deduction crud
     *
     * @param ValidateHrDeductionStore $request
     * @return JsonResponse
     */
    ...
    /**
     * Update procedure for deduction
     *
     * @param Request $request
     * @param integer|string $id
     * @return JsonResponse
