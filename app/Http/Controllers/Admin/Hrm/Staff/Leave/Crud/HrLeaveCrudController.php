...
namespace App\Http\Controllers\Admin\Hrm\Staff\Leave\Crud;
...
class HrLeaveCrudController  extends Controller {
    ...
    public function index(Request $request) : View | RedirectResponse
    {
        ...
        $data['leaveTypes'] = class_exists(\App\Models\HrLeaveType::class)
            ...
            : collect();
        return view('admin.pages.hrm.staff.leave.crud.index',compact('data'));
    }

    /**
     * List items for yajra datatable for leave crud
     *
     * @param Request $request
     * @return JsonResponse
     */
    ...
    /**
     * Store procedure for leave crud
     *
     * @param ValidateHrLeaveStore $request
     * @return JsonResponse
     */
