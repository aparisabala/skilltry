...
/*
 * API mirror of routes/admin/category/lib-specialization.php
...
use App\Http\Controllers\Api\V1\Admin\Category\Specialization\Crud\LibSpecializationController;
