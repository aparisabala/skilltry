...
<div class="mt-4 p-3">
    @can('ac_ledger_crud_store')
        <form id="frmStoreAcLedger" autocomplete="off">
            <input type="hidden" name="ledger_type" value="{{ $data['ledger_type'] }}" />
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card p-2 shadow-card card-border">
                                ...
                                <div class="form-group text-left mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" class="form-control" name="opening_balance" id="opening_balance" value="">
                                    </div>
