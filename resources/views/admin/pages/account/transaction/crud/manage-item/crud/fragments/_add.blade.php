...
<div class="mt-4 p-3">
    @can('ac_draft_balance_sheet_item_crud_store')
        <form id="frmStoreAcDraftBalanceSheetItem" autocomplete="off">
            <input type="hidden" value="{{ $data['draft']?->id }}" name="ac_draft_transaction_id" />
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card p-2 shadow-card card-border">
                                 <div class="form-group text-left mb-3">
                                    <label class="form-label"> <b>{{pxLang($data['lang'],'fields.folio_number')}}</b> <em class="required">*</em> <span id="folio_number_error"></span></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="folio_number" id="folio_number" value="-">
                                    </div>
                                </div>
                                <div class="form-group text-left mb-3">
