...
<div class="mt-4 p-3">
    @can('hr_leave_type_crud_store')
        <form id="frmStoreHrLeaveType" autocomplete="off">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card p-2 shadow-card card-border">
                                ...
                                <div class="form-group text-left mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="is_paid" id="is_paid"><option value="Yes" selected>Yes</option><option value="No">No</option></select>
                                    </div>
                                </div>
                                <div class="form-group text-left mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" min="0" step="1" class="form-control" name="days_per_year" id="days_per_year" value="0">
                                    </div>
                                </div>
