<div class="bg-info pl-2 page-fragment-bar">
    <span class="text-light"> <a href="{{url('admin/hrm/staff/education/'.$data['item']?->admin_user_id.'')}}"><span class="badge badge-info cursor-pointer"> <i class='fa-solid fa-arrow-left fs-16'></i></span></a> <span class="pt-1"> {{pxLang($data['lang'],'update')}}   </span> </span>
</div>
<div class="mt-4 p-3">
    @can('hr_education_crud_edit')
        <form id="frmUpdateHrEducation" autocomplete="off">
            @method('PATCH')
                            ...
                            <div class="card p-2 shadow-card card-border">
                                <div class="form-group text-left mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="degree" id="degree" value="{{$data['item']?->degree}}">
                                    </div>
                                </div>
                                <div class="form-group text-left mb-3">
                                    <label class="form-label"> <b>{{pxLang($data['lang'],'fields.institute')}}</b> <em class="required">*</em> <span id="institute_error"></span></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="institute" id="institute" value="{{$data['item']?->institute}}">
                                    </div>
                                </div>
                                <div class="form-group text-left mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="board_university" id="board_university" value="{{$data['item']?->board_university}}">
                                    </div>
                                </div>
                                <div class="form-group text-left mb-3">
                                    <label class="form-label"> <b>{{pxLang($data['lang'],'fields.subject')}}</b> <em class="required"></em> <span id="subject_error"></span></label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="subject" id="subject" value="{{$data['item']?->subject}}">
                                    </div>
                                </div>
                                <div class="form-group text-left mb-3">
                                ...
                                <div class="form-group text-left mb-3">
                                    ...
                                    <div class="input-group">
                                        <textarea class="form-control" name="description" id="description" rows="3">{{$data['item']?->description}}</textarea>
                                    </div>
                                </div>
