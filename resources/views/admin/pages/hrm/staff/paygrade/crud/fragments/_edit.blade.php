<div class="bg-info pl-2 page-fragment-bar">
    <span class="text-light"> <a href="{{url('admin/hrm/staff/pay-grade')}}"><span class="badge badge-info cursor-pointer"> <i class='fa-solid fa-arrow-left fs-16'></i></span></a> <span class="pt-1"> {{pxLang($data['lang'],'update')}}   </span> </span>
</div>
<div class="mt-4 p-3">
    @can('hr_pay_grade_crud_edit')
        <form id="frmUpdateHrPayGrade" autocomplete="off">
            @method('PATCH')
                        ...
                        <div class="col-md-6">
                            <div class="card p-2 shadow-card card-border">
                                ...
                                <div class="form-group text-left mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" min="0" step="0.01" class="form-control" name="min_basic" id="min_basic" value="{{$data['item']?->min_basic}}">
                                    </div>
                                </div>
                                <div class="form-group text-left mb-3">
                                    <label class="form-label"> <b>{{pxLang($data['lang'],'fields.max_basic')}}</b> <em class="required">*</em> <span id="max_basic_error"></span></label>
                                    <div class="input-group">
                                        <input type="number" min="0" step="0.01" class="form-control" name="max_basic" id="max_basic" value="{{$data['item']?->max_basic}}">
                                    </div>
                                </div>
                                <div class="form-group text-left mb-3">
