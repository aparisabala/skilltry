        ...
        <div class="col-md-12">
            @can('lib_department_view')
                @if($data['item'] != null || $data['type'] != "edit")
                    <div class="">
                        @include('admin.pages.datalibrary.department.crud.fragments._breadcum')
                        <div class="page-block-body">
                            @if($data['type'] == "add")
                                @include('admin.pages.datalibrary.department.crud.fragments._actions')
                                <div class="card rounded page-block">
                                    <div id="defaultPage" class="table-list pages">
                                        <div class="mt-2 p-2 p-md-4">
                                            ...
                                            @if(count($data['items']) > 0)
                                                ...
                                                @include('common.view.fragments._pdf-layout',['docTitle' => 'Department List'])
                                    ...
                                    <div id="addPage" class="d-none pages">
                                        @include('admin.pages.datalibrary.department.crud.fragments._add')
                                    </div>
                                </div>
                            @else
                                <div id="editPage" class="pages">
                                    <div class="card rounded-0 pb-3">
                                        <div id="loadEdit" class="w-100">
                                            @include('admin.pages.datalibrary.department.crud.fragments._edit')
                                        </div>
                                    </div>
                                </div>
                            @endif
