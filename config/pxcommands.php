...
return [
    ...
    'language' => [
        ...
        'admin.account.transaction.crud' => 'admin/account/transaction/crud/index',
        'admin.account.transaction.crud.manage-item.crud' => 'admin/account/transaction/crud/manage-item/crud/index',
        'admin.account.report.balance.data-view.display-balance' => 'admin/account/report/balance/data-view/display-balance/index',
        'admin.account.report.cashbook.load' => 'admin/account/report/cashbook/load/index',
        'admin.hrm.staff.education.crud' => 'admin/hrm/staff/education/crud/index',
        'admin.hrm.staff.experience.crud' => 'admin/hrm/staff/experience/crud/index',
        'admin.hrm.staff.employment.crud' => 'admin/hrm/staff/employment/crud/index',
        'admin.hrm.staff.advance.crud' => 'admin/hrm/staff/advance/crud/index',
        'admin.hrm.staff.deduction.crud' => 'admin/hrm/staff/deduction/crud/index',
        'admin.hrm.staff.leave.crud' => 'admin/hrm/staff/leave/crud/index',
        'admin.hrm.staff.leavetype.crud' => 'admin/hrm/staff/leavetype/crud/index',
        'admin.hrm.staff.holiday.crud' => 'admin/hrm/staff/holiday/crud/index',
        'admin.hrm.staff.paycomponent.crud' => 'admin/hrm/staff/paycomponent/crud/index',
        'admin.hrm.staff.paygrade.crud' => 'admin/hrm/staff/paygrade/crud/index',
        'admin.datalibrary.department' => 'admin/datalibrary/department/index',
        'admin.hrm.user.crud.modify.designation.crud' => 'admin/hrm/user/crud/modify/designation/crud/index',
        'admin.hrm.user.crud.modify.doctor-opd-slot.crud' => 'admin/hrm/user/crud/modify/doctor-opd-slot/crud/index',
        'admin.hrm.user.crud.modify.opd-fees.form.update' => 'admin/hrm/user/crud/modify/opd-fees/form/update/index',
    ]
];
